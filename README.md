...
* [Veritensor](https://github.com/arsbr/Veritensor) - DevSecOps tool for MLOps. Scans models for malware (RCE), datasets for poisoning, and generates cryptographic data provenance manifests.
